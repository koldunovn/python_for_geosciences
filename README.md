...
```
conda install ipython jupyter matplotlib scipy pandas basemap netcdf4 requests
```
...
- execute `conda install netcdf4 basemap requests` and agree with installation
